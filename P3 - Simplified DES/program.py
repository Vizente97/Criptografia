...
def subkey(key):
    temp = [] 
    subkey_temp = [] 
    subkey_temp = permutations(key,[2,4,1,6,3,9,0,8,7,5])
...
if __name__ == "__main__":
    ...
    if option == "E":
        ...
        resultado = (permutations(valor_feistelK2,[3,0,2,4,6,1,7,5]))
        ...
        resultado = (permutations(valor_feistelK1,[3,0,2,4,6,1,7,5]))
        print_result(resultado)